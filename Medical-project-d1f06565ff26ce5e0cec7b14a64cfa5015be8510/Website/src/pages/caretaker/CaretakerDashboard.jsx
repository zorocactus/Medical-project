...
function StatCard({ label, value, sub, icon: Icon, color, dk }) {
  const c = dk ? T.dark : T.light;
  return (
    <Card dk={dk} className="interactive-card group hover:border-blue-500/30">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="space-y-4">
            {patients.length === 0 ? (
              ...
              <Card key={patient.id} dk={dk} className="interactive-card group overflow-hidden relative hover:border-blue-500/30">
                ...
                <div className="flex items-center gap-3">
                  <button onClick={() => onChangePage("myPatients")} className="btn-secondary px-5 py-2 rounded-lg text-[11px] font-bold uppercase tracking-wider transition-all border"
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
             {emergencyContacts.map((contact, i) => (
               <Card key={i} dk={dk} className="interactive-card flex items-center justify-between hover:border-blue-500/20">
    ...
    <div className="animate-in fade-in duration-500 space-y-8">
      ...
      <div className="space-y-4">
        ...
        {active.map((req) => {
          ...
          return (
            <Card key={req.id} dk={dk} className={`interactive-card hover:shadow-md group transition-all ${isPending ? "border-amber-500/40" : ""}`}
