...
function Card({ children, className = "", style = {}, dk, interactive = true }) {
  ...
  return (
    <div
      className={`rounded-2xl p-5 shadow-sm border ${interactive ? 'interactive-card' : ''} ${className}`}
          ...
          <div key={idx} className="flex items-start gap-4">
            ...
            <div className="flex-1">
              {displayType === "empty" ? (
                ...
                <div
                  className={`interactive-card py-3 px-4 border-l-[3px] rounded-r-lg shadow-sm transition-all hover:translate-x-1 ${getTypeStyles(displayType)}`}
                >
    ...
    >
      ...
      <div className="flex flex-col gap-5">
        {safeRequests.map((req, idx) => (
          <div key={idx} className="interactive-card flex items-center justify-between group p-3 rounded-xl">
...
function PatientsView({ onSelectPatient }) {
  ...
  return (
    <div className="animate-in fade-in duration-500">
      ...
      <Card dk={dk} className="p-0 overflow-hidden" interactive={false}>
        {filtered.length === 0 ? (
            ...
            <div className="divide-y" style={{ borderColor: c.border }}>
              {paginated.map((p, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="interactive-card grid grid-cols-[2.5fr_0.8fr_1.5fr_1fr_1.3fr_1.2fr_1fr] px-6 py-4 items-center transition-all hover:bg-opacity-5"
