        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="relative">
              ...
              <label
                htmlFor="cinRecto"
                className={`flex flex-col items-center justify-center w-full h-40 rounded-2xl border-2 border-dashed ${files.cinRecto ? 'border-[#6492C9] bg-[#F4F8FB]' : 'border-[#D1DFEC] hover:border-[#89AEDB]'} cursor-pointer transition-colors group`}
              >
                <CreditCard
                  size={32}
                  strokeWidth={1.5}
            ...
            <div className="relative">
              ...
              <label
                htmlFor="cinVerso"
                className={`flex flex-col items-center justify-center w-full h-40 rounded-2xl border-2 border-dashed ${files.cinVerso ? 'border-[#6492C9] bg-[#F4F8FB]' : 'border-[#D1DFEC] hover:border-[#89AEDB]'} cursor-pointer transition-colors group`}
              >
                <CreditCard
                  size={32}
                  strokeWidth={1.5}
            ...
            <div className="relative">
              ...
              <label
                ...
                className={`flex flex-col items-center justify-center w-full h-40 rounded-2xl border-2 border-dashed ${files.profilePhoto ? 'border-[#6492C9] bg-[#F4F8FB]' : 'border-[#D1DFEC] hover:border-[#89AEDB]'} cursor-pointer transition-colors group`}
              >
                <User
                  size={32}
                  strokeWidth={1.5}
