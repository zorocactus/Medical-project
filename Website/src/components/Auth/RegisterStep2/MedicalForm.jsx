            ...
            <div className="relative group">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-10 py-3 rounded-xl border border-[#D1DFEC] hover:border-[#89AEDB] focus:border-[#6492C9] focus:ring-0 outline-none text-gray-700 text-sm transition-colors"
                />
            ...
            <div className="relative group md:col-span-1">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-4 pr-4 py-3 rounded-xl border border-[#D1DFEC] hover:border-[#89AEDB] focus:border-[#6492C9] focus:ring-0 outline-none text-gray-700 text-sm transition-colors placeholder:text-[#A0B5CD]"
                />
              </div>
            </div>
