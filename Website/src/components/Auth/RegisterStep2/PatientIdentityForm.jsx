...
export default function PatientIdentityForm({ onComplete, onBack }) {
  ...
  const handleDevFill = () => {
    onComplete({
      cinRecto: new File([""], "cin_recto_dev.jpg", { type: "image/jpeg" }),
      cinVerso: new File([""], "cin_verso_dev.jpg", { type: "image/jpeg" }),
      profilePhoto: new File([""], "profile_dev.jpg", { type: "image/jpeg" }),
    });
  };
      ...
      <div className="bg-white rounded-[24px] shadow-xl w-full max-w-[800px] px-[60px] py-[50px] relative">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="flex items-center w-full max-w-[480px] justify-between relative px-2">
            ...
            <div className="w-[32px] h-[32px] rounded-full bg-[#6492C9] text-white flex items-center justify-center font-bold text-sm z-10 shadow-sm relative"><Check size={16} strokeWidth={3} /></div>
            <div className="w-[32px] h-[32px] rounded-full bg-[#6492C9] text-white flex items-center justify-center font-bold text-sm z-10 relative">2</div>
            <div className="w-[32px] h-[32px] rounded-full bg-white border-2 border-[#D1DFEC] text-[#D1DFEC] flex items-center justify-center font-bold text-sm z-10 relative">3</div>
          </div>
        </div>
