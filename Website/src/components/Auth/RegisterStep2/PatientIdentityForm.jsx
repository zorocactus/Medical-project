    ...
    >
      <div className="w-full max-w-[480px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <UploadZone
            id="cinRecto"
            label={t("auth.register.identity.cinRecto")}
            hint={t("auth.register.identity.cinRecto")}
            file={files.cinRecto}
          ...
          <UploadZone
            id="cinVerso"
            label={t("auth.register.identity.cinVerso")}
            hint={t("auth.register.identity.cinVerso")}
            file={files.cinVerso}
          ...
          <UploadZone
            id="profilePhoto"
            label={t("auth.register.identity.profilePhoto")}
            hint={t("auth.register.identity.profilePhoto")}
